...
$string['col2text'] = 'Colour scheme 1';
$string['col3text'] = 'Colour scheme 2';
...
$string['apilabel'] = 'API Key';
$string['apidesc'] = 'API Key for Bionic Reading';
$string['bgdesc'] = 'Choose a colour to tint the screen';
$string['fgdesc'] = 'Choose a text colour';
$string['bg2label'] = 'Background colour 1';
$string['bg3label'] = 'Background colour 2';
$string['bg4label'] = 'Background colour 3';
$string['fg2label'] = 'Text colour 1';
$string['fg3label'] = 'Text colour 2';
$string['fg4label'] = 'Text colour 3';